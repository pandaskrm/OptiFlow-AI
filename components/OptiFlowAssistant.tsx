...
function handleSubmit(event: FormEvent<HTMLFormElement>) {
  ...
  return (
    <div className="fixed bottom-20 right-3 z-[100] flex flex-col items-end sm:bottom-28 sm:right-6">
      {open && (
        <section
          className={`fixed inset-0 flex h-[100dvh] w-screen flex-col overflow-hidden border border-cyan-400/20 bg-slate-950/98 shadow-2xl shadow-cyan-950/50 backdrop-blur-xl transition-all duration-500 ease-in-out sm:static sm:mb-4 sm:h-[min(740px,calc(100vh-120px))] sm:w-[clamp(500px,38vw,580px)] sm:rounded-3xl ${
            closing
